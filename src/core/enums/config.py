...
class Config (Enum):
    DEFAULT_REPULSION_FORCE = 50.0 # repulsion must be important compared to cohesion
    DEFAULT_SEPARATION_FORCE = 5.0
    DEFAULT_COHESION_FORCE = 0.1
    DEFAULT_ALIGNMENT_FORCE = 1.0

    DEFAULT_REPULSION_DIST = 100.0
    DEFAULT_SEPARATION_DIST = 20.0 # no need to get a large range to compute separation, if max speed is increasing you may extend a bit this range
